...
objects[project]=fields(isa='PBXProject',attributes=fields(BuildIndependentTargetsInParallel='YES',LastUpgradeCheck='2700'),buildConfigurationList=project_configs,compatibilityVersion=quote('Xcode 15.0'),developmentRegion='tr',hasScannedForEncodings='0',knownRegions=arr(['tr','en','Base']),mainGroup=main,productRefGroup=products,projectDirPath='""',projectRoot='""',targets=arr([target,test_target]))
